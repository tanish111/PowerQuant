...
class ExperimentLogger:
    ...
    def __init__(self, experiment_id: str, dataset_name: str, results_dir: str = 'results'):
        ...
        # Extract model name from experiment_id (e.g., "exp04_catboost" -> "catboost")
        model_name = experiment_id.replace('exp04_', '')
        # Results path: results/exp04/{dataset_name}/{model}/
        self.results_dir = Path(f'{project_root}/{results_dir}/exp04/{dataset_name}/{model_name}/')
