...
class ExperimentLogger:
    ...
    def __init__(self, experiment_id: str, dataset_name: str, results_dir: str = 'results'):
        self.experiment_id = experiment_id
        self.dataset_name = dataset_name
        # Extract model name from experiment_id (e.g., "exp05_catboost" -> "catboost")
        model_name = experiment_id.replace('exp05_', '')
        # Results path: results/exp05/{dataset_name}/{model}/
        self.results_dir = Path(f'{project_root}/{results_dir}/exp05/{dataset_name}/{model_name}/')
