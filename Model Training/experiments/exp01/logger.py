...
class ExperimentLogger:
    ...
    def __init__(self, experiment_id: str, results_dir: str = 'results'):
        ...
        # Extract model name from experiment_id (e.g., "exp01_catboost" -> "catboost")
        model_name = experiment_id.replace('exp01_', '')
        self.results_dir = Path(f'{project_root}/{results_dir}/exp01/{model_name}/')
